public class Car
{
    ...
    public void Run()
    {
        ...
        while (IsRunning)
        {
            ...
            if (input == "1") driverDoor.Toggle(IsLocked);
            else if (input == "2") passengerDoor.Toggle(IsLocked);
            else if (input == "3") clicker.IsArmed = true;
            else if (input == "4") clicker.IsArmed = false;
            else if (input == "5") IsLocked = ! IsLocked;
    ...
    public void PrintMenu()
    {
        ...
        Console.WriteLine("5. Lock/Unlock Doors");
...
public class Door
{
    ...
    public void Toggle(bool IsLocked)
    {
    if (IsLocked == false)
    {
